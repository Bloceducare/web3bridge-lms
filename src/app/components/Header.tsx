  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-8 py-4 bg-[#FCF7F2] shadow-lg fixed top-0 left-0 w-full z-10">
      ...
      <nav className="hidden md:flex space-x-8">
        <Link href="/courses" className="text-gray-800 hover:text-red-600">
          Courses
        </Link>
        <Link href="/learn" className="text-gray-800 hover:text-red-600">
          Learn
        </Link>
        <Link href="/blog" className="text-gray-800 hover:text-red-600">
          Blog
        </Link>
        <Link href="/pricing" className="text-gray-800 hover:text-red-600">
          Pricing
        </Link>
      </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#FCF7F2] shadow-lg py-4 px-6 flex flex-col space-y-4">
          <Link
            href="/courses"
            className="text-gray-800 hover:text-red-600 py-2"
          >
            Courses
          </Link>
          <Link href="/learn" className="text-gray-800 hover:text-red-600 py-2">
            Learn
          </Link>
          <Link href="/blog" className="text-gray-800 hover:text-red-600 py-2">
            Blog
          </Link>
          <Link
            href="/pricing"
